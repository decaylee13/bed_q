...
class Bed: 
    def __init__(self, bed_id):
        ...
        self.occupancy_delta = 10 # how long does the patient need to be in bed? this does not change; reset for new patients
